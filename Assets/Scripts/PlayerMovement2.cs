...
public class PlayerMovement2 : MonoBehaviour
{
    ...
    public static bool isBlockingTwo = false;
    ...
    private void OnEnable()
    {
        if (playerRight)
        {
            ...
            inputSystemActions.PlayerRight.Attack.started += Attack;
        ...
        else if (!playerRight)
        {
            ...
            inputSystemActions.PlayerLeft.Attack.started += Attack;
    ...
    private void Attack(InputAction.CallbackContext obj)
    {
        if (!attacked && !isBlockingTwo)
        {
            ...
            foreach (Collider enemy in hitEnemy)
            {
                ...
                // Způsobení poškození nepřátelům
                enemy.GetComponent<Health>().TakeDamage(_damage);
            }
            // Časově odložená deaktivace útoku
